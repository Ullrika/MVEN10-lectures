...
## OPTION: Environmental risk assessment of a pharmaceutical

Go to the page [Pharmaceuticals and Environment](https://janusinfo.se/beslutsstod/lakemedelochmiljo/pharmaceuticalsandenvironment.4.7b57ecc216251fae47487d9a.html)

(@) What organisation is behind this page and what do they want to achieve with it? (1p)

Search for the pharmaceutical given to you in the database and study the summary of the hazard and risk classification for this pharmaceutical. 

(@) Make a short description of the pharmaceutical given to you. (1p)

The hazard classification considers Persistence, Bioaccumulation and Toxicity. 

(@) Why are these endpoints relevant? (2p)

(@) Confirm and discuss limitations in the conclusions on these three endpoints and on risk by 

- referring to [information about the classifications](https://janusinfo.se/beslutsstod/lakemedelochmiljo/pharmaceuticalsandenvironment/environment/classification.5.7b57ecc216251fae47488423.html)

- considering data and other information presented on the summary page for the pharmaceutical (6p)

## OPTION: A risk assessment of a threathened species

Go to the page for the [IUCN Red list](https://www.iucnredlist.org/)

(1) What organisation is behind this page and what do they want to achieve with it? (1p)

Search for the species given to you in the database and study the summary of the red list assessment for this species. 

(2) Make a short description of the species given to you. (1p)
...
(3) Why are these criteria relevant? (2p)


(4) Confirm and discuss limitations in the conclusions on the criteria used for the assessment of the species provided to you by 
...
- considering data and other information presented on the assessment page for the species (6p)
...
(@) Consider the situation where the human NOAEL instead was 205 mg coumarin per kg per day. Propose and justify a new TDI in light of available data! For full points, show equations and the code for your calculations. (3p)
